...
```{r, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, warning=FALSE, error = FALSE, message = FALSE, fig.width=6, fig.height=4, fig.align = "center")
...
```{r, include=FALSE, fig.width=2, fig.show='hold', fig.align='center'}
# install.packages("gh")
# library(gh)
...
print0<-glue_data(.x = membersgit, .sep = "", '![{githublink}]({imagelink})')
...
leaflet() %>%
  ...
  addMarkers(lng=members$lon, lat=members$lat, group = "points",
             popup=paste("<b>", members$Name, "</b> 
                         ...
                         "<br/> ", ifelse(members$github %in% "", "", 
                                          paste0("<a href = ", members$GitHub, "> ",members$github,"'s GitHub </a> "))))
  ...
  # 
  # addPopupImages(image = membersgit$imagelink, group = "withgit", width = 300, height = 350/4)# width = 4*(300*2), height = 2*(350/8))
  #                # width = 300*12, height = 350)
```
